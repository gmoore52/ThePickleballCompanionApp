DROP TABLE IF EXISTS USER_STATISTICS_HST CASCADE;
...
CREATE TABLE USER_STATISTICS_HST(
                                    USER_NAME VARCHAR(32) REFERENCES USERS(USER_NAME),
                                    MAX_TIMESTAMP TIMESTAMP,
                                    TOTAL_WINS INTEGER NOT NULL,
                                    TOTAL_LOSSES INTEGER NOT NULL,
                                    TOTAL_GAMES INTEGER NOT NULL,
                                    WIN_LOSS_RATIO DECIMAL(10, 5),
                                    MOST_FREQ_LOCATION SERIAL REFERENCES LOCATIONS(LOC_ID),
                                    MOST_FREQ_TEAMMATE VARCHAR(32) REFERENCES USERS(USER_NAME),
                                    STRONGEST_OPPONENT VARCHAR(32) REFERENCES USERS(USER_NAME),
                                    MOST_LOSSES_TO_STRONGEST_OPPONENT INTEGER,
                                    PRIMARY KEY (USER_NAME, MAX_TIMESTAMP)
);
